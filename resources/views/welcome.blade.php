...
@section('content')
            ...
            <div
                ...
                <div>
                    ...
                    <div class="mt-2">
                        ...
                        <x-form.input
                            id="birthday" class="block mt-1 w-full" type="date" name="birthday" max="{{date('Y-m-d')}}"
                            required></x-form.input>
                    </div>
                </div>
            </div>
                    ...
                    <div class="my-2">
                        ...
                        <div class="seances my-3">
                            @foreach($seances as $seance)
                                <x-form.radio name="seance_id" value="{{$seance->id}}"
                                              class="seanceCheck">{{mb_substr($seance->name,0,5)}}</x-form.radio>
                            @endforeach
                        </div>
                    </div>
    ...
    <div class="w-1/2 mx-auto bg-amber-600 rounded-lg shadow-md">
        ...
        <div class="flex flex-row">
            <x-form.input
                id="last_name" class="hidden mt-1 w-full" value="{{Auth::user()->last_name}}" type="text" name="last_name"
                required ></x-form.input>
            <x-form.input
                id="first_name" class="hidden mt-1 w-full" value="{{Auth::user()->first_name}}" type="text" name="first_name"
                required ></x-form.input>
            <x-form.input
                id="father_name" class="hidden mt-1 w-full" value="{{Auth::user()->father_name}}" type="text" name="father_name" ></x-form.input>
            <x-form.input id="email" class="hidden mt-1 w-full"  type="text" name="email" value="{{Auth::user()->email}}"
                          required ></x-form.input>
            <x-form.input
